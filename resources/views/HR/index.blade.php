            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                     ...
                     <li>
                        <a  href="PendingLeaves.html"><i class="fa fa-file-text fa-3x"></i> Pending Leaves</a>
                    </li>
                    <li>
                        <a  href="RandF.html"><i class="fa fa-qrcode fa-3x"></i> Reports and Forms</a>
                    </li>
                      <li  >
                        <a  href="Employees.html"><i class="fa  fa-users fa-3x"></i> Employees</a>
                    </li>		  
                  <li  >
